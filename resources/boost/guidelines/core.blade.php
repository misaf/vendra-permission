...
- A role's guard changes only through `Actions\ChangeRoleGuardAction`, which remaps its permissions by name under the new guard. Never rewrite `guard_name` on a `Permission` to follow a role, since permissions are shared between roles.
